...
All labels, values, controls, timing, shuriken rotation, and particle animation are rendered deterministically by the plug-in. The artwork does not add an AI runtime dependency.
